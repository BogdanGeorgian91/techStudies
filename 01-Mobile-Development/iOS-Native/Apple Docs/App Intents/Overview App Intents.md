...
[`protocol AppShortcutsContent`](/documentation/appintents/appshortcutscontent)
...
[`struct ConfirmationConditions`](/documentation/appintents/confirmationconditions)

Conditions for a confirmation request.

[`struct EntityPropertyModifiers`](/documentation/appintents/entitypropertymodifiers)

[`struct EntityURLRepresentation`](/documentation/appintents/entityurlrepresentation)

The URL representation of an app entity.

[`struct EnumURLRepresentation`](/documentation/appintents/enumurlrepresentation)

The URL representation of an app enum.

[`struct FileEntityIdentifier`](/documentation/appintents/fileentityidentifier)
...
[`enum AppShortcutPhraseToken`](/documentation/appintents/appshortcutphrasetoken)
