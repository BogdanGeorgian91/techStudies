Got it ✅ — here’s that version cleaned up and converted into proper Markdown with headings, lists, tables, and code blocks:

# Designing and Creating a CloudKit Database | Apple Developer Documentation
...
## [Overview](/documentation/cloudkit/designing-and-creating-a-cloudkit-database#overview)
...
### [Design your objects as records](/documentation/cloudkit/designing-and-creating-a-cloudkit-database#Design-your-objects-as-records)

CloudKit allows you to store your data as [`CKRecord`](/documentation/cloudkit/ckrecord) objects, and relationships between those objects as [`CKRecord.Reference`](/documentation/cloudkit/ckrecord/reference) associations. Separate your data into record types by grouping objects of the same type together. If you’ve already separated your model data into classes, these classes might have the same record type in iCloud. Choose which objects and which of their properties and relationships you want to persist to iCloud.

Each object property that you persist maps to a key-value pair, known as a *field*, within a [`CKRecord`](/documentation/cloudkit/ckrecord). [`CKRecord`](/documentation/cloudkit/ckrecord) supports value types for your fields, such as [`String`](/documentation/Swift/String), or more complex types, such as [`Data`](/documentation/Foundation/Data).

For example, a “to-do item” might have the following record type:

| Key         | Type                                     | Example value    |
|-------------|------------------------------------------|------------------|
| title       | [`String`](/documentation/Swift/String)  | “Get apples”     |
| dueDate     | [`Date`](/documentation/Foundation/Date) | October 28, 2019 |
| isCompleted | [`Bool`](/documentation/Swift/Bool)      | false            |

For information on additional supported value types, see [`CKRecord`](/documentation/cloudkit/ckrecord).

### [Create records programmatically](/documentation/cloudkit/designing-and-creating-a-cloudkit-database#Create-records-programmatically)

Create a [`CKRecord`](/documentation/cloudkit/ckrecord) object with a string representing the type of record you want to store, using [`initWithRecordType:`](/documentation/cloudkit/ckrecord/initwithrecordtype:). Every record type must have a unique string name.
...
Schemas
	•	API Reference: Managing iCloud Containers with CloudKit Database App
...
Current page is Designing and Creating a CloudKit Database
