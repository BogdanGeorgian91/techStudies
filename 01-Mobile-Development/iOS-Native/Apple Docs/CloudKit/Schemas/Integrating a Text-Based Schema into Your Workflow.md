# Integrating a Text-Based Schema into Your Workflow | Apple Developer Documentation
...
## [Overview](/documentation/cloudkit/integrating-a-text-based-schema-into-your-workflow#overview)
...
### [Learn the CloudKit Schema Language Grammar](/documentation/cloudkit/integrating-a-text-based-schema-into-your-workflow#Learn-the-CloudKit-Schema-Language-Grammar)
...
### [Recognize Implicit Fields and Roles](/documentation/cloudkit/integrating-a-text-based-schema-into-your-workflow#Recognize-Implicit-Fields-and-Roles)
...
### [View an Example Schema](/documentation/cloudkit/integrating-a-text-based-schema-into-your-workflow#View-an-Example-Schema)
...
## [See Also](/documentation/cloudkit/integrating-a-text-based-schema-into-your-workflow#see-also)

### [Schemas](/documentation/cloudkit/integrating-a-text-based-schema-into-your-workflow#Schemas)
...
Current page is Integrating a Text-Based Schema into Your Workflow