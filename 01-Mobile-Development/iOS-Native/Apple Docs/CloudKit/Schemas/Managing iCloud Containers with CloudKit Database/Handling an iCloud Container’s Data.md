# Handling an iCloud Container’s Data | Apple Developer Documentation
...
## [Overview](/documentation/cloudkit/handling-an-icloud-container-s-data#overview)
...
### [Create a record](/documentation/cloudkit/handling-an-icloud-container-s-data#Create-a-record)
...
### [Modify or delete a record](/documentation/cloudkit/handling-an-icloud-container-s-data#Modify-or-delete-a-record)
...
## [See Also](/documentation/cloudkit/handling-an-icloud-container-s-data#see-also)

### [Container Management](/documentation/cloudkit/handling-an-icloud-container-s-data#Container-Management)
...
Current page is Handling an iCloud Container’s Data